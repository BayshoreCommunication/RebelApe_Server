...
const stripe = Stripe(config_1.default.stripe_secret_key);
const OWNER_EMAIL = config_1.default.owner_email;
const STRIPE_NAVIGATE_URL = config_1.default.stripe_navigate_url;
...
const initiateStripePayment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendSingleProductEmail = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const sendMultipleProductsEmail = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
